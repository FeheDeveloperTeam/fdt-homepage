...
const TMI_LIST = [
  ...
  '페헤는 유명해진 뒤에 평소엔 연락도 안 하던 사람이 갑자기 아는 척 하는 걸 극도로 싫어합니다',
  '페헤는 수상할 정도로 보컬로이드를 좋아합니다',
]
...
const TIMELINE = [
  ...
  {
    year: '2025 — 2027',
    heading: '다인아이앤씨 국가근로장학생',
    body: '결제 단말기 및 키오스크 솔루션 전문 기업 다인아이앤씨에서 IT 운영 지원 업무를 담당하고 있습니다.',
    duties: [
